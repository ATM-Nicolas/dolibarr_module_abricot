...
$var=!$var;
print '<tr '.$bc[$var].'>';
print '<td>'.$langs->trans("set_ABRICOT_USE_DOLIBARR_METHOD_TO_CONVERT_PDF").'</td>';
print '<td align="center" width="20">&nbsp;</td>';
print '<td align="right" width="300">';
print '<form method="POST" action="'.$_SERVER['PHP_SELF'].'">';
print '<input type="hidden" name="token" value="'.$_SESSION['newtoken'].'">';
print '<input type="hidden" name="action" value="set_ABRICOT_USE_DOLIBARR_METHOD_TO_CONVERT_PDF">';
echo ajax_constantonoff('ABRICOT_USE_DOLIBARR_METHOD_TO_CONVERT_PDF');
print '</form>';
print '</td></tr>';
